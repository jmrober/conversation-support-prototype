...
export default function ThreadList({ threads, selectedId, onSelect, onNewCall, onNewInternalChat }: Props) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center gap-3 h-48 text-center px-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Use New Call to reach out, or wait for an inbound contact.</p>
            </div>
          </div>
        ) : (
          <>
              ...
              <>
                ...
                <div className="flex items-center border-t border-gray-100 bg-gray-50">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 mr-1 rounded-lg text-gray-400 hover:text-blue-700 hover:bg-blue-50 transition-colors flex-shrink-0"
                  >
      ...
      <div className="flex-shrink-0 border-t border-gray-100 px-4 py-3">
        <button
          onClick={onNewCall}
          className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-semibold text-blue-800 border border-blue-300 rounded-xl bg-transparent hover:bg-blue-50 hover:border-blue-400 transition-colors"
        >
